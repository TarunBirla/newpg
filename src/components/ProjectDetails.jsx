...
const ProjectDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await http.post("/projectinquiry", formData);
      ...
      <section className="py-16 bg-white">
        ...
        <div className="space-y-8">
          ...
          <div className="w-full">
            ...
            >
              <p className="text-lg leading-relaxed max-w-6xl">
                Premier Realty stands as one of Kolkata’s most trusted and
                progressive real estate developers, known for shaping the city’s
                skyline with excellence, innovation, and integrity. With a
                strong foundation built on quality craftsmanship and customer
                trust, Premier Realty has been consistently delivering projects
                that blend
                <br /> modern architecture with sustainable living.
              </p>
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            >
              <p className="text-lg leading-relaxed max-w-6xl">
                Each development is thoughtfully designed to provide a perfect
                balance of luxury, functionality, and connectivity – offering
                residents and investors spaces that truly enhance their
                lifestyle and long-term value. From premium residential
                complexes to cutting-edge commercial spaces, every project
                reflects meticulous
                <br /> attention to detail and a commitment to excellence.
              </p>
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            >
              <p className="text-lg leading-relaxed max-w-6xl">
                Driven by a vision to redefine urban living in Kolkata, Premier
                Realty integrates advanced design practices, green building
                concepts, and contemporary amenities to create communities that
                inspire growth and well-being. Our focus on transparency,
                on-time delivery, and customer satisfaction continues to
                position us as a preferred choice for homebuyers and investors
                seeking trusted real estate solutions in Kolkata.
              </p>
            </div>
          </div>
        </div>
